...
const DashboardView: React.FC<DashboardViewProps> = ({ 
  ...
  // Filter logs to show only those scheduled for today or earlier
            ...
            <div className="bg-surface-dark rounded-xl overflow-hidden">
              <form onSubmit={handleSubmit}>
                <textarea 
                  ...
                  placeholder="Record your thoughts or tasks (e.g., - [ ] New task)..."
                />
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              <span className="material-icons text-primary">analytics</span> Today's Stream
            </h2>
          </div>
          {todayLogs.length === 0 ? (
